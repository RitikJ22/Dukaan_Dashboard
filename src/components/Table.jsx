...
const TableCardItem=({orderId,refundDate,transactionfees,orderAmount})=>
{
    return (
        <tr className=' border-b'>
            ...
            <td className='text-text py-3.5 px-3 text-sm leading-5 font-medium text-right'>{transactionfees}</td>
